  ...
  return (
    <div className="space-y-12">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex gap-3 items-start">
            ...
            <div>
              <p className="font-medium">Gate Fusion</p>
              <p className="text-sm text-muted-foreground">Combines multiple quantum gates into optimized composite operations</p>
            </div>
          </div>
          <div className="flex gap-3 items-start">
            <div className="w-1.5 h-1.5 rounded-full bg-[#22d3ee] mt-2 flex-shrink-0" />
            <div>
              <p className="font-medium">Circuit Depth Reduction</p>
              <p className="text-sm text-muted-foreground">Minimizes circuit depth for better performance on NISQ devices</p>
            </div>
          </div>
          <div className="flex gap-3 items-start">
            <div className="w-1.5 h-1.5 rounded-full bg-[#22d3ee] mt-2 flex-shrink-0" />
            <div>
              <p className="font-medium">Classical Optimization</p>
              <p className="text-sm text-muted-foreground">LLVM-based compilation for classical code paths</p>
            </div>
          </div>
          <div className="flex gap-3 items-start">
            <div className="w-1.5 h-1.5 rounded-full bg-[#22d3ee] mt-2 flex-shrink-0" />
            <div>
              <p className="font-medium">Auto-Parallelization</p>
              <p className="text-sm text-muted-foreground">Automatically parallelizes independent quantum operations</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-[#22d3ee]/5 to-[#a855f7]/5 border border-border rounded-lg p-5">
            <h4 className="font-semibold mb-2">Quantum Machine Learning</h4>
            <p className="text-sm text-muted-foreground">
              Build quantum neural networks, variational algorithms, and hybrid ML models that leverage 
              quantum advantage for pattern recognition and optimization.
            </p>
          </div>

          <div className="bg-gradient-to-r from-[#a855f7]/5 to-[#22d3ee]/5 border border-border rounded-lg p-5">
            <h4 className="font-semibold mb-2">Cryptography & Security</h4>
            <p className="text-sm text-muted-foreground">
              Implement quantum key distribution, post-quantum encryption algorithms, and quantum-safe 
              security protocols for next-generation secure communications.
            </p>
          </div>

          <div className="bg-gradient-to-r from-[#22d3ee]/5 to-[#a855f7]/5 border border-border rounded-lg p-5">
            <h4 className="font-semibold mb-2">Optimization Problems</h4>
            <p className="text-sm text-muted-foreground">
              Solve complex optimization challenges in logistics, finance, and operations research using 
              quantum annealing and variational quantum algorithms.
            </p>
          </div>

          <div className="bg-gradient-to-r from-[#a855f7]/5 to-[#22d3ee]/5 border border-border rounded-lg p-5">
            <h4 className="font-semibold mb-2">Quantum Simulation</h4>
            <p className="text-sm text-muted-foreground">
              Simulate molecular dynamics, materials science, and chemical reactions with quantum accuracy 
              for drug discovery and materials engineering.
            </p>
          </div>
        </div>
      </div>
