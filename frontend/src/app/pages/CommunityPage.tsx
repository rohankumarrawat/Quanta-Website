  ...
  const questions = [
    {
      ...
      preview: "I'm trying to implement a simple error correction code using the Memory Core module. The documentation mentions automatic error correction, but I need more control over the correction strategy...",
    ...
    },
    {
      ...
      preview: "My Quanta code compiles but the resulting circuit depth is too large for current NISQ devices. What are the recommended approaches for reducing circuit depth while maintaining algorithm correctness?",
    ...
    },
    {
      ...
      answers: 0,
      views: 456,
      title: "Entanglement API - creating multi-qubit Bell states",
      preview: "The examples show creating 2-qubit Bell states, but I need to create 4-qubit GHZ states. Is there a built-in function or do I need to manually compose the gates?",
      tags: ["entanglement", "bell-states", "api"],
      username: "qbit_explorer",
    ...
    },
    {
      ...
      answers: 8,
      views: 2145,
      title: "Quanta vs Qiskit - when to use which?",
      preview: "I'm currently using Qiskit for quantum algorithm development. What are the main advantages of switching to Quanta? Are there specific use cases where Quanta excels?",
      tags: ["comparison", "qiskit", "getting-started"],
    ...
    },
    {
      ...
      answers: 2,
      views: 678,
      title: "Type inference not working for quantum state variables",
      preview: "The compiler is throwing type errors when I try to use automatic type inference with quantum states. Do I need to explicitly annotate all quantum types?",
      tags: ["type-system", "compiler", "bug"],
      username: "type_safe_quantum",
    ...
    },
    {
      ...
      answers: 6,
      views: 1567,
      title: "Performance benchmarks: Quanta simulator vs real quantum hardware",
      preview: "Has anyone run performance comparisons between the built-in Quanta simulator and actual quantum processors? I want to know if my code will scale when moving to hardware.",
      tags: ["performance", "benchmarks", "hardware"],
      username: "quantum_bench",
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Find answers, share knowledge, build with Quanta.
              </p>
            </div>
            <button className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gradient-to-r from-[#22d3ee] to-[#a855f7] text-background font-medium hover:shadow-lg hover:shadow-[#22d3ee]/25 transition-all hover:scale-105">
      ...
      <aside className="w-[280px] flex-shrink-0 space-y-6">
        ...
        <div className="bg-gradient-to-br from-[#22d3ee]/10 to-[#a855f7]/10 border border-[#22d3ee]/20 rounded-xl p-6">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li className="flex gap-2">
              <span className="text-[#22d3ee]">•</span>
              <span>Provide minimal examples</span>
            </li>
            <li className="flex gap-2">
              <span className="text-[#22d3ee]">•</span>
