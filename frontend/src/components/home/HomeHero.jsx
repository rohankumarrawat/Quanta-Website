            ...
            <div className="container relative">
                ...
                <div className="max-w-3xl mx-auto text-center relative z-10">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold mb-0">
                        {t('home_hero.title_before')}{' '}
                        <span className="text-primary">{t('home_hero.title_answer')}</span> {t('is', 'is')}{' '}
                        {t('to_ask', 'to ask a good')}{' '}
                        <span className="relative inline-block">
                            {t('home_hero.title_question')}
                    ...
                    <form className="bg-white rounded-lg p-2 mt-6 shadow-sm" onSubmit={(e) => e.preventDefault()}>
                        <div className="flex">
                            <input className="flex-1 px-4 py-3 border-0 bg-transparent text-heading focus:outline-none" type="search" placeholder={t('home_hero.search_placeholder')} />
