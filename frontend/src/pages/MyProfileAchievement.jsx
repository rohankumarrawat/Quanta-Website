        ...
        <div>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
                <div className="card p-4 text-center">
                    <h4 className="text-primary mb-0">456</h4>
                    <span className="text-sm text-body">{t('profile.achievements.points', 'Points')}</span>
                </div>
                <div className="card p-4 text-center">
                    <h4 className="text-success mb-0">4</h4>
                    <span className="text-sm text-body">{t('profile.achievements.badges_earned', 'Badges Earned')}</span>
                </div>
                <div className="card p-4 text-center">
                    <h4 className="text-warning mb-0">#12</h4>
                    <span className="text-sm text-body">{t('profile.achievements.global_rank', 'Global Rank')}</span>
                </div>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {badges.map((b, i) => (
                    <div key={i} className={`card p-4 text-center ${!b.earned ? 'opacity-50' : ''}`}>
                        ...
                        {b.earned && (
                            <span className="badge bg-success/10 text-success mt-2">
                                {t('profile.achievements.earned', 'Earned')}
                            </span>
                        )}
                    </div>
                ))}
